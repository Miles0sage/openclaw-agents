...
**Date**: 2026-03-04 | **Capabilities**: Multi-agent job pipeline, 75+ MCP tools, 4-tier LLM fallback, persistent memory, eval harness
**Models**: Claude Opus 4.6, MiniMax M2.5, Grok grok-3-mini, Kimi 2.5, Gemini 2.5 Flash

<!-- Configure your deployment environment, VPS IP, and domains -->
...
<!-- Configure your production database project IDs and environment -->
...
4. Overseer verifies output quality before responding to operator
